                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(UserProfileActivity.this, "Profile Pic upload Successfully...", Toast.LENGTH_SHORT).show();
                                    ...
                                    RootRef.child("Users").child(currentUserID).child("image")
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        Toast.makeText(UserProfileActivity.this, "Image save in Database, Successfully...", Toast.LENGTH_SHORT).show();
                                                        loadingBar.dismiss();
                                                    } else {
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if((dataSnapshot.exists()) && (dataSnapshot.hasChild("name")) && (dataSnapshot.hasChild("image"))){
                            ...
                            userName.setVisibility(View.VISIBLE);
                            Toast.makeText(UserProfileActivity.this, "Please set & update your profile info...", Toast.LENGTH_SHORT).show();
                        }
                    }
